                    ...
                    <div class="row gy-3">
                        ...
                        <div class="col-sm-6">
                            ...
                            <select name="provincia" class="form-control radius-8">
                                ...
                                <?php $selectedProv = $_POST['provincia'] ?? $solicitud['provincia'] ?? 'Alicante'; ?>
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" name="ciudad" class="form-control radius-8" value="<?php echo e($_POST['ciudad'] ?? $solicitud['ciudad'] ?? ''); ?>">
                        </div>
                        <div class="col-sm-12">
