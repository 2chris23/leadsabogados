...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .nav-logo { width: 280px; height: auto; max-width: 100%; object-fit: contain; }
        ...
        @media (max-width: 768px) {
            ...
            .nav-logo { width: 190px; height: auto; max-width: 100%; object-fit: contain; }
            .nav-menu { gap: 6px; }
            .btn-portal { font-size: 0.75rem; padding: 4px 8px; white-space: nowrap; }
