...
<div class="login-wrapper">
    ...
    <div class="login-image-side">
        <img src="<?php echo APP_URL; ?>/assets/images/steptodown.com753320.jpg?v=<?php echo $logoVersion; ?>" alt="Consulta jurídica">
    ...
    <div class="login-form-side">
        <div class="login-logo">
            <img src="<?php echo APP_URL; ?>/assets/images/logo.png?v=<?php echo $logoVersion; ?>" alt="Logo">
