...
$solicitud = $db->fetchOne(
    "SELECT s.*, u.nombre as p_nom, u.apellidos as p_ape
     FROM solicitudes s LEFT JOIN usuarios_internos u ON s.procesada_por=u.id WHERE s.id=?", [$id]
);
...
?>
<link rel="stylesheet" href="<?php echo APP_URL; ?>/assets/css/solicitud-ver.css">
